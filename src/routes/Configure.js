    ...
    <div>
      ...
      <form>
        ...
        <select id="gameMode" type='string' defaultValue={settings.gamemode}>
          <option className="n-mode" value={'player'}>Player</option>
          <option className="a-mode" value={'ai'}>AI</option>
        </select>
        ...
        <input id="fieldWidth" type='number' defaultValue={settings.fieldwidth}
          min={2}
          max={20}
          step={2}
        ></input>
        <label htmlFor="height">Field Height: </label>
        <input id="fieldHeight" type='number' defaultValue={settings.fieldheight}
          min={4}
          max={40}
          step={4}
        ></input>
